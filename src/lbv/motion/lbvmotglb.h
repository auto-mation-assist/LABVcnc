/********************************************************************
* Description: lbvmotglb.h
*   Declarations for globals whose default values are found in lbvmotcfg.h
*
...
/*! \todo FIXME - want to move some of these out of here completely...
   too many globals - put in lbvmotXXX structs instead, perhaps?
*/

    extern char LBVMOT_INIFILE[LBVMOT_INIFILE_LEN];

    extern unsigned int SHMEM_KEY;

    extern double LBVMOT_COMM_TIMEOUT;	/* seconds until timeout */
