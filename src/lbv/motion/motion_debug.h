...
#include "motion.h"             // LBV_TELEOP_DATA
...
/*! \todo FIXME-- default is used; dynamic is not honored */
	...
	lbvmot_joint_t joints[LBVMOT_MAX_JOINTS];	/* joint data */
	lbvmot_axis_t axes[LBVMOT_MAX_AXIS];	        /* axis data */
#endif
