...
#ifndef LABVCNCROTARYDELTAKINS_COMMON_H
#define LABVCNCROTARYDELTAKINS_COMMON_H
...
static int kinematics_forward(const double *joints, LbvPose *pos) {
    double
        j0 = joints[0],
        j1 = joints[1],
        j2 = joints[2],
...
static int kinematics_inverse(const LbvPose *pos, double *joints) {
    double xr, yr;
