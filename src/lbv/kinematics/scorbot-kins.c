...
static void compute_j1_cartesian_location(double j0, LbvPose *j1_cart) {
...
int kinematicsForward(
    ...
    LbvPose j1_vector;  // the vector from j0 ("base") to joint 1 ("shoulder", end of link 0)
    LbvPose j2_vector;  // the vector from j1 ("shoulder") to  joint 2 ("elbow", end of link 1)
    LbvPose j3_vector;  // the vector from j2 ("elbow") to joint 3 ("wrist", end of link 2)
...
// "cartesian" coordinates of LabvCNC's world space.  The R coordinate
