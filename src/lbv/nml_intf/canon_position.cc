...
CANON_POSITION::CANON_POSITION(const LbvPose &_pos) {
    this->x = _pos.tran.x;
    this->y = _pos.tran.y;
    this->z = _pos.tran.z;
    this->a = _pos.a;
...
CANON_POSITION & CANON_POSITION::operator+=(const LbvPose &o) {
    this->x += o.tran.x;
    this->y += o.tran.y;
    this->z += o.tran.z;
    this->a += o.a;
...
const CANON_POSITION CANON_POSITION::operator+(const LbvPose &o) const {
    CANON_POSITION result = *this;
    result += o;
    return result;
}
...
const LbvPose CANON_POSITION::toLbvPose() const {
    LbvPose out;
    out.tran.x = this->x;
    out.tran.y = this->y;
    out.tran.z = this->z;
