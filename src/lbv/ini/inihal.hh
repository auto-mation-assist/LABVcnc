...
\
    ARRAY(hal_float_t,joint_backlash,LBVMOT_MAX_JOINTS) \
    ARRAY(hal_float_t,joint_ferror,LBVMOT_MAX_JOINTS) \
    ARRAY(hal_float_t,joint_min_ferror,LBVMOT_MAX_JOINTS) \
    ARRAY(hal_float_t,joint_min_limit,LBVMOT_MAX_JOINTS) \
    ARRAY(hal_float_t,joint_max_limit,LBVMOT_MAX_JOINTS) \
    ARRAY(hal_float_t,joint_max_velocity,LBVMOT_MAX_JOINTS) \
    ARRAY(hal_float_t,joint_max_acceleration,LBVMOT_MAX_JOINTS) \
    ARRAY(hal_float_t,joint_home,LBVMOT_MAX_JOINTS) \
    ARRAY(hal_float_t,joint_home_offset,LBVMOT_MAX_JOINTS) \
    ARRAY(hal_s32_t,  joint_home_sequence,LBVMOT_MAX_JOINTS) \
\
    ARRAY(hal_float_t,axis_min_limit,LBVMOT_MAX_AXIS) \
    ARRAY(hal_float_t,axis_max_limit,LBVMOT_MAX_AXIS) \
    ARRAY(hal_float_t,axis_max_velocity,LBVMOT_MAX_AXIS) \
    ARRAY(hal_float_t,axis_max_acceleration,LBVMOT_MAX_AXIS) \
