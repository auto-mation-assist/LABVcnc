...
* Early March 2007 MGS adapted this to lbv2
*
...
StandaloneInterpInternals::StandaloneInterpInternals() :
  ...
  optional_program_stop(ON), //set enabled by default (previous LBV behaviour)
  /* optional block delete */
  block_delete(ON), //set enabled by default (previous LBV behaviour)
  motion_tolerance(0.),
