...
LBV_STAT *lbvStatus = new LBV_STAT;

// LBV_IO_STAT *lbvIoStatus = new LBV_IO_STAT;

int lbvOperatorDisplay(int, char const*, ...) {return 0;};

int lbvOperatorText(int, char const*, ...) {return 0;}

// int lbvOperatorError(int, char const*, ...) {return 0;}
