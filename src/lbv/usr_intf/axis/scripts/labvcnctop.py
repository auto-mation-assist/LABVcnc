...
maps = {
'exec_state': {labvcnc.EXEC_ERROR: 'error',
                labvcnc.EXEC_DONE: 'done',
                labvcnc.EXEC_WAITING_FOR_MOTION: 'motion',
                labvcnc.EXEC_WAITING_FOR_MOTION_QUEUE: 'motion queue',
                labvcnc.EXEC_WAITING_FOR_IO: 'io',
                labvcnc.EXEC_WAITING_FOR_MOTION_AND_IO: 'motion and io',
                labvcnc.EXEC_WAITING_FOR_DELAY: 'delay',
                labvcnc.EXEC_WAITING_FOR_SYSTEM_CMD: 'system command',
                labvcnc.EXEC_WAITING_FOR_SPINDLE_ORIENTED: 'spindle orient'},
'motion_mode':{labvcnc.TRAJ_MODE_FREE: 'free', labvcnc.TRAJ_MODE_COORD: 'coord',
                labvcnc.TRAJ_MODE_TELEOP: 'teleop'},
'interp_state':{labvcnc.INTERP_IDLE: 'idle', labvcnc.INTERP_PAUSED: 'paused', 
                labvcnc.INTERP_READING: 'reading', labvcnc.INTERP_WAITING: 'waiting'},
'task_state':  {labvcnc.STATE_ESTOP: 'estop', labvcnc.STATE_ESTOP_RESET: 'estop reset',
                labvcnc.STATE_ON: 'on', labvcnc.STATE_OFF: 'off'},
'task_mode':   {labvcnc.MODE_AUTO: 'auto', labvcnc.MODE_MDI: 'mdi',
                labvcnc.MODE_MANUAL: 'manual'},
...
'kinematics_type': {labvcnc.KINEMATICS_IDENTITY: 'identity', labvcnc.KINEMATICS_FORWARD_ONLY: 'forward_only', 
                    labvcnc.KINEMATICS_INVERSE_ONLY: 'inverse_only', labvcnc.KINEMATICS_BOTH: 'both'},
...
def gui():
    ...
    root = Tkinter.Tk(className="LabvCNCTop")
    rs274.options.install(root)
    root.title(_("LabvCNC Status"))
