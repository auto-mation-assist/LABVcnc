...
class INI:
    ...
    def write_inifile(self, base):
        ...
        elif self.d.frontend == _PD._TKLABVCNC:
            print >>file, "DISPLAY = tklabvcnc"
        ...
        print >>file, "INTRO_GRAPHIC = labvcnc.gif"
        print >>file, "INTRO_TIME = 5"
        print >>file, "PROGRAM_PREFIX = %s" % \
                                    os.path.expanduser("~/labvcnc/nc_files")
        if self.d.pyvcp:
        ...
        print >>file
        print >>file, "[RS274NGC]"
        print >>file, "PARAMETER_FILE = labvcnc.var"

        #base_period = self.d.ideal_period()

        print >>file
        print >>file, "[LBVMOT]"
        print >>file, "LBVMOT = motmod"
    ...
    # labvcnc doesn't like having home right on an end of travel,
