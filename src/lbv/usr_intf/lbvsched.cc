...
#include "lbvsched.hh"          // Common scheduling functions
...
bool isIdle()
{
   return ((lbvStatus->task.interpState != LBV_TASK_INTERP_READING) && 
