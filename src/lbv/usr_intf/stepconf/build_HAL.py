...
class HAL:
    ...
    def write_halfile(self, base):
        ...
        print >>file, "loadrt [LBVMOT]LBVMOT base_period_nsec=[LBVMOT]BASE_PERIOD servo_period_nsec=[LBVMOT]SERVO_PERIOD num_joints=[KINS]JOINTS"
        ...
        if self.d.pyvcp and self.d.pyvcphaltype == 1 and self.d.pyvcpconnect: # spindle speed/tool # display
            ...
            if encoder:
                ...
                print >>f1, _("# **** Use COMMANDED spindle velocity from LabvCNC because no spindle encoder was specified")
                print >>f1
