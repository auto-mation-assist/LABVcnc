...
*       It decodes keyboard codes then update pins/labvcnc commands.
...
/** This file, 'sampler_usr.c', is the user part of a HAL component
    ...
    It then calls a python program to update pins or send labvcnc commands.
    The python part uses INI style configs to define 'buttons', that either
    update hal pins, call labvcnc commands or optionally call a user function.
...
/** This program is free software; you can redistribute it and/or
    ...
    This code was written as part of the LABVCNC HAL project.  For more
