...
MODULE_INFO(labvcnc, "component:hostmot2:RTAI driver for the HostMot2 firmware from Mesa Electronics.");
MODULE_INFO(labvcnc, "funct:read:1:Read all registers.");
MODULE_INFO(labvcnc, "funct:write:1:Write all registers, and pet the watchdog to keep it from biting.");
MODULE_INFO(labvcnc, "license:GPL");
