File changes for LBV classicladder 7.124 from original 7.124
Jan. 2007
...
arrays.c:
--- changed extensively. Removed most allocation code besides what LBV needs for realtime and user programs. 
...
SUBMAKEFILE:
--- completely different for LBV. This makefile is for the user program only. 
...
--- added lbv_mods.c to compile list
