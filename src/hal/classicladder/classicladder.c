...
// This is an adaption of classicladder V7.124 For LBV
...
void display_help (void)
{
    ...
    printf("This version of Classicladder is adapted for use with LBV and HAL\n"
...
int main( int   argc, char *argv[] )
{
	...
	compId=hal_init("classicladder"); //lbv
	if (compId<0) return -1; //lbv
	signal(SIGTERM,do_exit); //lbv
