...
// this code has been highly modified for LBV 2
// LBV uses RTAPI realtime code to allocate shared memory / run calculations
// and HAL code for input/output 'pins' to other programs
// this adaptation was started Jan 2008 by Chis Morley
// see LBV_readme for more info
...
//for lbv next 2 lines
#include "rtapi.h"
#include "rtapi_string.h"
//#include <linux/string.h>

#include "classicladder.h"
#ifndef RTAPI //for LBV :realtime has no directory access
#include "files.h" 
#endif
#include "calc.h"
