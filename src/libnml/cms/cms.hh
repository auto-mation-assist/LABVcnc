...
class CMS {
  ...
  /***********************************************/
    ...
    CMS_STATUS update(char &x);                            /* Used by lbv2 */
    CMS_STATUS update(unsigned char &x);                   /* Used by lbv2 */
    CMS_STATUS update(short int &x);
    CMS_STATUS update(unsigned short int &x);
    CMS_STATUS update(int &x);                             /* Used by lbv2 */
    CMS_STATUS update(unsigned int &x);
    CMS_STATUS update(long int &x);                        /* Used by lbv2 */
    CMS_STATUS update(unsigned long int &x);               /* Used by lbv2 */
    CMS_STATUS update(float &x);
    CMS_STATUS update(double &x);                          /* Used by lbv2 */
    CMS_STATUS update(long double &x);
    CMS_STATUS update(char *x, unsigned int len);          /* Used by lbv2 */
    CMS_STATUS update(unsigned char *x, unsigned int len); /* Used by lbv2 */
    CMS_STATUS update(short *x, unsigned int len);
    CMS_STATUS update(unsigned short *x, unsigned int len);
    CMS_STATUS update(int *x, unsigned int len);           /* Used by lbv2 */
    ...
    CMS_STATUS update(double *x, unsigned int len);        /* Used by lbv2 */
   ...
   ************************************************************************/
    // translation types
    CMS_STATUS update(PM_CARTESIAN & x);	// Cart /* Used by lbv2 */
