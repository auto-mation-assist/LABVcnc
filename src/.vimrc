"
" This file is intended to make 'vim' better match the style of lbv2 source
...
augroup lbv2
 " Remove all prior lbv2 autocommands
 au!
...
" This assumes the working directory is lbv2/src which is also required for
