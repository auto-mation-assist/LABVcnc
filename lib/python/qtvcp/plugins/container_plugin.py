...
####################################
# Labvcnc State Enable GridLayout
####################################
class StateEnableGridLayoutPlugin(QPyDesignerCustomWidgetPlugin):
    ...
    def group(self):
        return "Labvcnc - Controller"
    def icon(self):
        return QtGui.QIcon(QtGui.QPixmap(ICON.get_path('state_enable_gridlayout')))
    def toolTip(self):
        return "Labvcnc State enable/disable GridLayout widget"
    def whatsThis(self):
        return ""
...
class JointEnableWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    ...
    def toolTip(self):
        return "Labvcnc Joint Availablility enable/disable widget"
    def whatsThis(self):
        return ""
    def isContainer(self):
        return True
