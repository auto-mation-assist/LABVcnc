...
class _TStat(object):
    ...
    # converts from labvcnc toolfile array to toolwear array
    # labvcnc handles toolwear by having tool wear as extra tools with tool numbers above 10000 (fanuc style)
    ...
    # converts from toolwear array to labvcnc toolfile array
    # labvcnc handles toolwear by having tool wear as extra tools with tool numbers above 10000 (fanuc style)
    # qtvcp just adds the extra tool wear positions (x and z) to the original array 
    ...
    def _save(self, new_model, delete=()):
        ...
        try:
            ...
            LOG.error("reloading of tool table into labvcnc: {}".format(self.toolfile))
            return True
