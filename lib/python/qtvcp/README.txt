...
/usr/lib/qt4/designer/python/ (labvcnc plugins)

to:
RIP_folder /lib/python/qtvcp_widgets/widget_plugins/ (labvcnc plugins)
...
test2.ui is for testing/interacting with a running labvcnc session.
