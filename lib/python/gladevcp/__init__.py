...
if support_aux_apps:
    ...
    # location defined by the substitution item LABVCNC_AUX_GLADEVCP.
    # The location is available from the script labvcnc_var
    # (this script should always be in PATH for both RIP builds and
    # deb installs of LabvCNC)
    s = subprocess.Popen(['labvcnc_var','LABVCNC_AUX_GLADEVCP']
