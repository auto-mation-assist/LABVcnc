...
# This widgets controls labvcnc's override rate
#
...
class Override(gtk.HScale):
    ...
    def set_type(self, data=0):
        ...
        self.inifile = self.lbv.ini(INIPATH)
    ...
    # This is a signal callback that commands labvcnc based on the current
    # scale position
    ...
    # it polls labvcnc to get the current data
