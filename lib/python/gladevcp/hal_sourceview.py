...
from hal_filechooser import _LBV_FileChooser

import gtksourceview2 as gtksourceview

class LBV_SourceView(gtksourceview.View, _LBV_ActionBase):
    __gtype_name__ = 'LBV_SourceView'
    __gproperties__ = {
    ...
    def __init__(self, *a, **kw):
        ...
        if 'LBV2_HOME' in os.environ:
            path = os.path.join(os.environ['LBV2_HOME'], 'share/gtksourceview-2.0/language-specs/')
    ...
    # Set the hilight line to the line labvcnc is looking at.
...
class LBV_Action_Save(_LBV_Action, _LBV_FileChooser):
    __gtype_name__ = 'LBV_Action_Save'
    __gproperties__ = { 'textview' : (LBV_SourceView.__gtype__, 'Textview',
                    "Corresponding textview widget", gobject.PARAM_READWRITE),
    }
    def __init__(self, *a, **kw):
        _LBV_Action.__init__(self, *a, **kw)
        self.textview = None
    ...
    def do_set_property(self, property, value):
        ...
        if name == 'textview':
            ...
            return _LBV_Action.do_set_property(self, property, value)
    ...
    def do_get_property(self, property):
        ...
        if name == 'textview':
            ...
            return _LBV_Action.do_get_property(self, property)


class LBV_Action_SaveAs(LBV_Action_Save):
    __gtype_name__ = 'LBV_Action_SaveAs'
