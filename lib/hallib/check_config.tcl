...
# Ref: src/lbv/nml_intf/lbvcfg.h,src/lbv/ini/inijoint.cc,src/lbv/iniaxis.cc:
...
proc check_extrajoints {} {
  if ![info exists ::LBVMOT(LBVMOT)] return
  if {[string first motmod $::LBVMOT(LBVMOT)] <= 0} return
...
#----------------------------------------------------------------------
# begin
package require Labvcnc ;# parse_ini
