...
from axis.py (LabvCNC 2.5) or"] \[DISPLAY\]USER_COMMAND_FILE (LabvCNC 2.4)"
  }
  ...
  if {[info procs ::ngcui::gui] == ""} {
    ...
    puts "\n[_ LabvCNC version"] = $::version"
    puts "[_ "for labvCNC 2.5.xxx, Do not include tkapp.py in the ini file"]\n"
  ...
  foreach fname $ngcgui_subfile {
    ...
    if {"$wtab" == "None"} {
      # functions of tkapp.py were incorporated in LabvCNC  2.5 27dec10 af6ae9907e1c0
      #puts "\nerrorInfo: $::errorInfo"
      puts "\n[_ "LabvCNC version"] = $::version"
      puts "[_ "for LabvCNC 2.5.xxx, Do not include tkapp.py in the ini file"]\n"
      continue
