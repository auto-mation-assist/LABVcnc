...
###############################################################
# Description:  lbvtesting.tcl
#               LBV performance testing program
#
...
if {! [string length [info commands lbv_plat]]} {
    error "lbvtesting needs to run from \"lbvsh\""
}
...
proc popupTesting {{w .testingwindow}} {
    ...
    bind $lw.amp.chk <ButtonRelease-1> "lbv_axis_enable \$axisentry \$ampenable"

    frame $lw.buttons
    button $lw.buttons.set -text Set -command "lbv_axis_set_output \$axisentry \$outvolts"
