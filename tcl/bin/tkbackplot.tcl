...
###############################################################
# This is plot processes for tklbv popup under the view menu 
# of tklbv.  The fixed size of the canvas viewing area is 500x250 
...
proc popupPlot {} {
    ...
    toplevel $d
    wm title $d [msgcat::mc "TkLabvCNC BackPlot"]
