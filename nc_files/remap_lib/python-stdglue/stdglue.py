...
def setspeed_epilog(self,**words):
    try:
        ...
        if self.blocks[self.remap_level].builtin_used:
            ...
            lbvcanon.enqueue_SET_SPINDLE_SPEED(self.speed)
        return INTERP_OK
    except Exception,e:
...
def setfeed_epilog(self,**words):
    try:
        ...
        if self.blocks[self.remap_level].builtin_used:
            ...
            lbvcanon.enqueue_SET_FEED_RATE(self.feed_rate)
        return INTERP_OK
    except Exception,e:
    ...
    try:
        ...
        if self.blocks[self.remap_level].builtin_used:
            ...
            if self.return_value > 0:
                ...
                lbvcanon.SELECT_POCKET(self.selected_pocket, self.selected_tool)
                return INTERP_OK
            else:
    ...
    try:
        ...
        if self.blocks[self.remap_level].builtin_used:
            ...
            if self.return_value > 0.0:
                ...
                lbvcanon.CHANGE_TOOL(self.selected_pocket)
    ...
    try:
        ...
        if self.blocks[self.remap_level].builtin_used:
            ...
            if self.return_value > 0.0:
                ...
                lbvcanon.CHANGE_TOOL_NUMBER(self.current_pocket)
                # cause a sync()
...
def set_tool_number(self, **words):
    try:
        ...
        if words['q'] > -TOLERANCE_EQUAL: # 'greater equal 0 within interp's precision'
            ...
            lbvcanon.CHANGE_TOOL_NUMBER(pocket)
            # cause a sync()
            self.tool_change_flag = True
            self.set_tool_parameters()
            return INTERP_OK
...
_compat = {
    lbvcanon.CANON_PLANE_XY : (("z","r"),_uvw,"XY"),
    lbvcanon.CANON_PLANE_YZ : (("x","r"),_uvw,"YZ"),
    lbvcanon.CANON_PLANE_XZ : (("y","r"),_uvw,"XZ"),
    lbvcanon.CANON_PLANE_UV : (("w","r"),_xyz,"UV"),
    lbvcanon.CANON_PLANE_VW : (("u","r"),_xyz,"VW"),
    lbvcanon.CANON_PLANE_UW : (("v","r"),_xyz,"UW")}           
