...
def canonmove(self, x,y,z):
    lbvcanon.STRAIGHT_FEED(lineno(),x,y,z,0,0,0,0,0,0)
    lbvcanon.STRAIGHT_TRAVERSE(lineno(),self.params["_ini[config]xpos"],self.params["_ini[config]ypos"],self.params["_ini[config]zpos"],0,0,0,0,0,0)
    return 0.0
