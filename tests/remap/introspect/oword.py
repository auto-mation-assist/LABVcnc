...
#
import interpreter
LBV_DEBUG_CONFIG            = 0x00000002
LBV_DEBUG_VERSIONS          = 0x00000008
LBV_DEBUG_TASK_ISSUE        = 0x00000010
LBV_DEBUG_NML               = 0x00000040
LBV_DEBUG_MOTION_TIME       = 0x00000080
LBV_DEBUG_INTERP            = 0x00000100
LBV_DEBUG_RCS               = 0x00000200
LBV_DEBUG_INTERP_LIST       = 0x00000800
LBV_DEBUG_IOCONTROL         = 0x00001000
LBV_DEBUG_OWORD             = 0x00002000
LBV_DEBUG_REMAP             = 0x00004000
LBV_DEBUG_PYTHON            = 0x00008000
LBV_DEBUG_NAMEDPARAM        = 0x00010000
LBV_DEBUG_GDBONSIGNAL       = 0x00020000
