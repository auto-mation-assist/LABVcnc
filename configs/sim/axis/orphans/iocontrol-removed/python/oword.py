...
def show_lbvstat(self,*args,**kwargs):
    try:
        task.pytask.enqueue.show_lbvstat(*args,**kwargs)
        if debug(): print "enqueueing show_lbvstat()",args
    except Exception,e:
        if debug(): print "show_lbvstat:",e,"pid=",os.getpid()
        pass
